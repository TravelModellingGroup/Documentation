...
# -*- coding: utf-8 -*-
#
# Frabitztown documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'tmgdoc.tex', 'Travel Modelling Group Documentation',
     '', 'manual'),
]
...
man_pages = [
    (master_doc, 'tmgdoc', 'Travel Modelling Group Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TMGDoc', 'Travel Modelling Group Documentation',
     author, 'TMGDoc', 'User guides and documentation for TMG software and tools.',
     'Miscellaneous'),
]

def setup(app):
    app.add_stylesheet('css/tmg-style.css')  # may also be an URL
